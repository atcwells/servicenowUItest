(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.opsdui = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (factory) {
  'use strict';
...
},{"angular":"angular","chart.js":3}],2:[function(require,module,exports){
/**
...
},{"./controllers":5,"./directives":6,"./filters":19,"./services":23,"angular-chart.js":1,"angular-multiple-selection":2,"chart.js":3}],5:[function(require,module,exports){
'use strict';
...
},{"./opsduiFilter/opsduiFilter":8,"./opsduiLineGraph/opsduiLineGraph":10,"./opsduiOptions/opsduiOptions":12,"./opsduiReportWindow/opsduiReportWindow":14,"./opsduiSeaCard/opsduiSeaCard":16,"./opsduiSeaWindow/opsduiSeaWindow":18,"angular":"angular"}],7:[function(require,module,exports){
angular.module('ngify').run(['$templateCache', function($templateCache){$templateCache.put('opsduiFilter.html','<div class="row"> <div class="col-md-12"><h4>Filter</h4></div> <div class="col-md-6"><h5>Filter by</h5></div> <div class="col-md-6"><h5>Order by</h5></div> </div>')}]);
module.exports = 'opsduiFilter.html';
...
},{"./opsduiFilter.html":7}],9:[function(require,module,exports){
angular.module('ngify').run(['$templateCache', function($templateCache){$templateCache.put('opsduiLineGraph.html','<div> <canvas id="line" class="chart chart-line" chart-data="data" chart-labels="labels" chart-legend="true" chart-series="series" chart-click="onClick" style="width: 100%"></canvas> </div>')}]);
module.exports = 'opsduiLineGraph.html';
...
},{"./opsduiLineGraph.html":9}],11:[function(require,module,exports){
angular.module('ngify').run(['$templateCache', function($templateCache){$templateCache.put('opsduiOptions.html','<div class=""> <h4>Options</h4> </div>')}]);
module.exports = 'opsduiOptions.html';
...
},{"./opsduiOptions.html":11}],13:[function(require,module,exports){
angular.module('ngify').run(['$templateCache', function($templateCache){$templateCache.put('opsduiReportWindow.html','<div> <opsdui-line-graph></opsdui-line-graph> </div>')}]);
module.exports = 'opsduiReportWindow.html';
...
},{"./opsduiReportWindow.html":13}],15:[function(require,module,exports){
angular.module('ngify').run(['$templateCache', function($templateCache){$templateCache.put('opsduiSeaCard.html','<a multiple-selection-item ng-class="{\'selecting\': isSelecting ,\'selected\': isSelected}" class="ui card" href="http://www.dog.com"> <div class="content"> <div class="header"></div> <div class="meta"> <span class="category">{{card.cmdb_ci}}</span> </div> <div class="description"> <p>{{card.short_description | truncFilter:true:20}}</p> </div> </div> <div class="extra content"> <div class="right floated author"> <img class="ui avatar image" ng-src="{{card.assignedToImage}}">{{card.assignedTo}} </div> </div> </a>')}]);
module.exports = 'opsduiSeaCard.html';
},{}],16:[function(require,module,exports){
require('./opsduiSeaCard.html');

module.exports = opsduiSeaCard = function ($templateCache) {
    return {
        restrict: 'E',
        priority: 100,
        transclude: true,
        template: $templateCache.get('opsduiSeaCard.html'),
        link: function (scope, attrs) {
...
},{"./opsduiSeaCard.html":15}],17:[function(require,module,exports){
angular.module('ngify').run(['$templateCache', function($templateCache){$templateCache.put('opsduiSeaWindow.html','<div> <div multiple-selection-zone class="row"> <opsdui-sea-card class="col-md-2" ng-repeat="card in seas"></opsdui-sea-card> </div> </div>')}]);
module.exports = 'opsduiSeaWindow.html';
...
},{"./opsduiSeaWindow.html":17}],19:[function(require,module,exports){
'use strict';
var app = require('angular').module('opsdui');

app.filter('truncFilter', require('./truncFilter/truncFilter'));
},{"./truncFilter/truncFilter":20,"angular":"angular"}],20:[function(require,module,exports){
module.exports = truncFilter = function () {
...
module.exports = AbstractDataService = function (AbstractDataService) {
...
//app.factory('AbstractDataService', require('./AbstractDataService'));
app.factory('PageLayoutService', require('./PageLayoutService'));
app.factory('SeaDataService', require('./SeaDataService'));
},{"./PageLayoutService":21,"./SeaDataService":22,"angular":"angular"}]},{},[4])(4)
});